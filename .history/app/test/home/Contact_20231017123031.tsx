    ...
    <div className="flex rounded-xl bg-custom-blue-green w-full h-[80vh] my-[5vh] flex-col shadow-md overflow-hidden px-8">
      ...
      >
        ...
        <textarea
          ...
          className={`${
            errors.user_name ? "outline outline-red-600" : "outline-none"
          } w-full font-medium text-[16px] text-gray-900 rounded-md border-gray-700 bg-[#9AEB59] flex flex-grow px-2 placeholder:text-gray-600 placeholder:text-opacity-50`}
        />
