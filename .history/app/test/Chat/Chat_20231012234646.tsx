    ...
    if (inputValue.trim() !== "") {
      ...
      fetch("/api/chat", {
        ...
        body: JSON.stringify({
          prompt: {
            context:
              "You are Plant Pal, a friendly AI assistant for agriculture. You have a lot of experience in agriculture. Also you have power to search data across the Internet. So you can produce accure ",
            examples: [
              {
                input: {
                  content: "Hi",
