      ...
      {isToggled ? (
        <div className="p-1 flex-col drop-shadow-2xl shadow-2xl fixed bottom-[170px] right-[85px] w-[320px] h-[65vh] bg-white rounded-xl flex overflow-hidden">
          ...
          <div className="flex flex-grow flex-col overflow-y-scroll justify-end pb-2">
            <div className="my-2 max-w-[85%] flex justify-start">
              <p className=" text-[14px] leading-tight px-1 py-2 bg-green-400 rounded-t-lg rounded-br-lg rounded-bl-none  justify-start">
                Hello! I'm Plant Pal. Your agri assistant. How can I help you
                today?
              </p>
            </div>
            <div className="my-2 max-w-[85%] flex justify-end">
              <p className=" text-[14px] leading-tight px-1 py-2 bg-blue-400 rounded-t-lg rounded-bl-lg rounded-br-none">
                Hello!
              </p>
            </div>
          </div>
