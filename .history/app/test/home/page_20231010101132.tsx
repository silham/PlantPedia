        ...
        <div className="w-[60%] h-full">
          <div className="flex flex-col justify-center h-full">
            ...
            <div>
              <button
                type="button"
                className="hidden sm:flex items-center w-[100px] text-left space-x-3 px-4 h-12 bg-white ring-1 ring-slate-900/10 hover:ring-slate-300 focus:outline-none focus:ring-2 focus:ring-sky-500 shadow-sm rounded-lg text-slate-600"
              >
                <svg
                  width="24"
                  height="24"
