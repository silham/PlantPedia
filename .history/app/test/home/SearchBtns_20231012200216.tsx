...
export const SideSearchBtn: React.FC = () => {
  ...
  return (
    <>
      <div
        id="sideSearchBtn"
        className="fixed bottom-[50px] right-0 opacity-0 rounded-full bg-custom-blue-green shadow-xl w-[50px] h-[50px] flex items-center justify-center cursor-pointer"
        onClick={openSearch}
      >
