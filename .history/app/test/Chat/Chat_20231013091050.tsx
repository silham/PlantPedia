        ...
        <div className="p-1 flex-col drop-shadow-2xl shadow-2xl fixed bottom-[170px] right-[85px] w-[320px] h-[65vh] bg-white rounded-xl flex overflow-hidden">
                    ...
                    >
                      <p
                        className={`text-[14px] leading-tight px-1 py-2 ${
                          message.author == "0" ? "bg-blue-300" : "bg-green-300"
                        } rounded-t-lg rounded-bl-lg rounded-br-none max-w-[85%] min-w-[25px]`}
                      >
                        {message.content}
                      </p>
                    </div>
          ...
          <div className="flex w-full h-[8%]">
            <input
              ref={inputRef}
              id="input"
              className="pl-1 text-[14px] border-2 border-custom-blue-green focus-visible:border-custom-blue-green h-full rounded-lg flex-grow"
              maxLength={500}
