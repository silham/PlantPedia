...
const Chat = () => {
  ...
  return (
    <>
      ...
      {isToggled ? (
        <div className="fixed bottom-[170px] right-[85px] w-[300px] h-[65vh] bg-white rounded-xl flex overflow-hidden">
          <div className="flex w-full h-[20%] bg-gradient-to-r from-custom-blue-green to-custom-green"></div>
          <div></div>
        </div>
      ) : null}
    </>
