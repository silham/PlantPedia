...
export const SideSearchBtn: React.FC = () => {
  ...
  return (
    <>
      <div
        id="sideSearchBtn"
        className="fixed bottom-[60px] right-0 opacity-0 rounded-full bg-custom-blue-green shadow-xl border  w-[50px] h-[50px] flex items-center justify-center cursor-pointer"
        onClick={openSearch}
      >
