    ...
    <>
      ...
      {isToggled ? (
        <div className="p-1 flex-col drop-shadow-2xl shadow-2xl fixed bottom-[170px] right-[85px] w-[320px] h-[65vh] bg-white rounded-xl flex overflow-hidden">
          ...
          <div className="flex flex-grow flex-col overflow-y-scroll justify-end py-2">
            <div className="my-2 w-full flex">
              <p className=" text-[14px] font-medium leading-tight px-1 py-2 bg-green-500 rounded-t-lg rounded-br-lg rounded-bl-none max-w-[85%] justify-start">
