...
const Chat = () => {
  ...
  return (
    <>
      ...
      {isToggled ? (
        <div className="p-1 drop-shadow-2xl shadow-2xl fixed bottom-[170px] right-[85px] w-[300px] h-[65vh] bg-white rounded-xl flex overflow-hidden">
          <div className="flex w-full h-[20%] bg-custom-blue-green rounded-xl"></div>
          <div className="flex flex-grow"></div>
          <div className="flex w-full h-[10%]">
            <input className="border border-gray-700 h-full" />
          </div>
        </div>
      ) : null}
    </>
