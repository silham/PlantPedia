    ...
    if (isGettingMsg) {
      ...
      fetch(
        ...
        .then((data) => {
          ...
          if (document.querySelector(".scrollable-div") !== null) {
            const scrollableDiv: HTMLDivElement =
              document.querySelector(".scrollable-div");
            const lastMessage: HTMLDivElement =
              document.querySelector(".last-message");

            scrollableDiv.addEventListener("scroll", () => {
              if (lastMessage.getBoundingClientRect().top < 0) {
