    ...
    <>
      <section className="h-[100vh] w-[100vw] px-[100px] hero bg-cover text-white">
        ...
        <div className="w-[60%]">
          ...
          <h4 className="text-[18px] text-justify leading-tight w-[90%]">
            ...
            hobbyists to experts, Plantpedia has something for everyone. Whether
            you want to identify a plant, get tips on how to grow it, or
            discover its medicinal or culinary uses, Plantpedia has you covered.
            You can also join our vibrant community of plant enthusiasts, where
            you can ask questions, share your experiences, and learn from
            others. Plantpedia is more than just a website, it’s a way of life.
            Join us today and start your journey into the wonderful world of
            plants.
          </h4>
        </div>
      </section>
