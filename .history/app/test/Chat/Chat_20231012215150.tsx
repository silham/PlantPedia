        ...
        <div className="p-1 flex-col drop-shadow-2xl shadow-2xl fixed bottom-[170px] right-[85px] w-[320px] h-[65vh] bg-white rounded-xl flex overflow-hidden">
          ...
          <div className="flex flex-grow flex-col overflow-y-scroll ">
            <div className="my-2 w-full flex">
              <p className=" text-[14px] font-medium leading-tight px-1 py-2 bg-green-500 rounded-t-lg rounded-br-lg rounded-bl-none max-w-[80%] justify-start">
                Hello! I'm Plant Pal. Your agri assis tant. How can I help you
                today?
              </p>
            </div>
          </div>
