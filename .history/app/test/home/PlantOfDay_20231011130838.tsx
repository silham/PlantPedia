...
const PlantOfDay = () => {
  ...
  return (
    <div className="flex rounded-xl bg-custom-blue-green w-full h-[80vh] my-[5vh] flex-col">
      ...
      <div className="w-full h-full flex items-center pt-4 pb-4 px-4 justify-around">
        {Pod.plant.common_name != "" ? (
          <>
            <div
              className="h-[75%] w-[40%] bg-amber-800 rounded-xl overflow-hidden"
            ...
            <div className="h-[75%] w-[40%] bg-custom-green rounded-xl"></div>
          </>
        ) : null}
      </div>
    </div>
