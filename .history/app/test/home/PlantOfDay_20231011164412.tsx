        ...
        {Pod.plant.common_name != "" ? (
          <>
            ...
            <div className="h-full w-[40%] bg-custom-green rounded-xl flex items-center flex-col p-4">
              ...
              <div className="bg-white text-[16px] w-full flex-grow rounded-md p-2">
                {Pod.plant.description}
              </div>
              <Link href={UrlGen("plant", Pod.plant.scientific_name)}>
                <button className="bg-custom-blue-green text-white text-[16px] font-semibold mt-2 p-2 rounded-md">
                  Learn more...
                </button>
              </Link>
            </div>
