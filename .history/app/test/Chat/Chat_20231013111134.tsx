...
const Chat = () => {
      ...
      fetch(
        "https://generativelanguage.googleapis.com/v1beta3/models/chat-bison-001:generateMessage?key=AIzaSyB7E6ela5BzmhRGnUqapTzw3tlpGM2d_G0",
        {
          ...
          body: JSON.stringify({
            prompt: {
              context:
                "You are Plant Pal, a friendly AI assistant for agriculture. You have a lot of experience in agriculture. Also you have power to search data across the Internet.",
              examples: [
                {
                  input: {
                    content: "Hi",
  ...
  return (
    <>
      ...
      {isToggled ? (
        <div className="p-1 flex-col drop-shadow-2xl shadow-2xl fixed bottom-[170px] right-[85px] w-[320px] max-h-[65vh] h-auto bg-white rounded-xl flex overflow-hidden">
          ...
          <div className="flex flex-grow overflow-y-scroll max-h-[72%] flex-col justify-end pb-2">
            <div className="h-fit">
